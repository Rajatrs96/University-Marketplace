  ...
  const registerHandle = async (e) => {
    ...
    try {
      const { data } = await axios
        .post('http://localhost/backend_file/register.php', config)
        .then((response) => {
    ...
    <div id="registercontainer">
      <div class="registercred">
        <div class="reg-details">
          ...
          <input id="phonenumber" type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" onChange={(e) => setPhoneNumber(e.target.value)} placeholder="123-456-7890" required/>
          <label>Email</label>
          <input id="regemail" type="email" onChange={(e) => setEmail(e.target.value)} placeholder="email@email.com" required/>
          <label>Password</label>
          <input id="regpassword" type="password" pattern=".{6,}" onChange={(e) => setPassword(e.target.value)} placeholder="Minimum 6 characters" required/>
        ...
        <input id="role" type="radio" name="role" value="businessowner" onChange={(e) => setRole(e.target.value)} style={{height:15, width:'auto'}} /> 
        
        <label for="role">Admin</label>
        <input id="role" type="radio" name="role" value="schooladmin" onChange={(e) => setRole(e.target.value)} style={{height:15, width:'auto'}} /> 

        <label for="role">Super Admin</label>
        <input id="role" type="radio" name="role" value="superadmin" onChange={(e) => setRole(e.target.value)} style={{height:15, width:'auto'}} /> 
