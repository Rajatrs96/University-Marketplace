...
if(isset($postdata) && !empty($postdata)){
    ...
    $select = " SELECT * FROM addnewproducts WHERE email = '$email' ";
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        $insert = "INSERT INTO addnewproducts(title, description, price, email, number) VALUES('$title','$description', '$price', '$email', '$number')";
